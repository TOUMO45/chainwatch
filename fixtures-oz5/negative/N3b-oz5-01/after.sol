...
contract Vault is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(address owner_, address feeRecipient_, uint256 feeBps_) external reinitializer(2) {
...
contract VaultFactory {
    ...
    function deployVault(address owner_, address feeRecipient_) external returns (address) {
        ...
        ERC1967Proxy proxy = new ERC1967Proxy(
            ...
            abi.encodeCall(Vault.initialize, (owner_, feeRecipient_, 0))
        );
